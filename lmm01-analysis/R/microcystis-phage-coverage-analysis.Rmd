...
pdf(file = "../plots/lmm01-combined-plot.pdf", width = 10, height = 6, useDingbats = F)
final_plot <- arrangeGrob(gp, gp3, gp2, nrow = 2, ncol = 2, widths = c(8,2))
dev.off()

ggdraw() +
  draw_plot(final_plot, x = 0.02, y = 0, width = .96, height = .96) +
  draw_plot(legend, x = 0.8, y = 0.2, width = 0.2, height = 0.2)
